...
(function(html) {
    ...
    const magicCursor = new MagicCursor({
        ...
        width: "2rem",
        height: "2rem",
        // References :- https://developer.mozilla.org/en-US/docs/Web/CSS/border
        outerBorderWidth: '3rem',  // With the help of it you can increase width of outer circle
        // outerBorderType: 'dashed',  // With the help of it you can set Border style of outer circle
        // playButton: true,  // With the help of it you can convert inner dot into play Button
      });
